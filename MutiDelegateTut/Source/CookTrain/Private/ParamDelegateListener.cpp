...
void AParamDelegateListener::BeginPlay()
{
	...
	if (TheWorld != nullptr)
	{
		...
		ACookTrainGameModeBase * MyGameMode =
			Cast<ACookTrainGameModeBase>(GameMode);
		if (MyGameMode != nullptr)
		{
			//MyGameMode->cusParamDelegate.BindUObject(this, &AParamDelegateListener::SetLightColor);
			MyGameMode->cusParamDelegate.BindUObject(this, &AParamDelegateListener::SetLightColor,true);
		}
	}
